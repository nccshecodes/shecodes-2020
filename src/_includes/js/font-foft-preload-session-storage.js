...
(function () {
	...
	(function () {
		...
		B.prototype.load = function (a, b) {
			...
			return new Promise(function (a, b) {
				if (J() && !G()) {
					const M = new Promise(function (a, b) {
							function e() {
	...
	const fontHead = new FontFaceObserver('roboto_monoregular');
	const fontBody = new FontFaceObserver('robotolight');
	const fontBold = new FontFaceObserver('robotomedium');

	Promise.all([
		fontHead.load(null, 10000),
		fontBody.load(null, 10000),
